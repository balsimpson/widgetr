...
| Next action | Run the pending focused visual-data, Bitcoin adapter, and reference-intake tests and typecheck, then verify the deployed WebMCP, export, and iPhone gates |
