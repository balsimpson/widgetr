...
| Local branch | `main` |
| Local and remote commit | `HEAD` (toolbar alignment fix committed and synchronized with `origin/main`) |
| Latest verified UI commit | `HEAD` (toolbar history capsule and Export alignment) |
