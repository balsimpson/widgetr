...
| Local branch | `main` |
| Local and remote commit | `HEAD` (Projects/Export icon alignment committed and synchronized with `origin/main`) |
| Latest verified UI commit | `HEAD` (matched the Projects and Export icon slots) |
