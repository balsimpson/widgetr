...
| Local branch | `main` |
| Local and remote commit | `HEAD` (assistant handoff tabs committed and synchronized with `origin/main`) |
| Latest verified UI commit | `HEAD` (Assistant handoff History/Tools tabs) |
