...
| Local branch | `main` |
| Local and remote commit | `HEAD` (visibility control removal committed and synchronized with `origin/main`) |
| Latest verified UI commit | `HEAD` (simplified canvas size controls) |
